                    ...
                    <li>
                        ...
                        >
                            <img
                                ...
                                src="https://www.datocms-assets.com/85254/1667813084-playstation.jpeg"
                ...
                <ol className="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
                    <li>
                        ...
                        >
                            <img
                                className="w-12 h-12 mb-3 mr-3 rounded-full sm:mb-0"
                                src="https://www.datocms-assets.com/85254/1667791884-datocms.jpeg"
                                alt="DatoCMS image"
                            />
                    ...
                    <li>
                        ...
                        >
                            <img
                                className="w-12 h-12 mb-3 mr-3 rounded-full sm:mb-0"
                                src="https://www.datocms-assets.com/85254/1667812768-nextjs.jpeg"
                                alt="Next.js image"
                            />
                            <div>
                                <div className="text-base font-normal text-gray-600 dark:text-gray-400">
                ...
                <ol className="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
                    <li>
                        ...
                        >
                            <img
                                className="w-12 h-12 mb-3 mr-3 rounded-full sm:mb-0"
                                src="https://www.datocms-assets.com/85254/1667811959-astro.jpeg"
                                alt="Astro image"
                            />
                            <div className="text-gray-600 dark:text-gray-400">
                                <div className="text-base font-normal">
